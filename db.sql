...
CREATE TABLE IF NOT EXISTS cms_users (us_id INT AUTO_INCREMENT PRIMARY KEY, us_login VARCHAR(32) UNIQUE NOT NULL, us_password VARCHAR(32) NOT NULL);
...
INSERT INTO cms_users (us_id, us_login, us_password) VALUES (NULL, 'hartunb', MD5('hartunb'));
